...
import SharingStateBetweenComponents1 from './(4)-managing-state/(3)-sharing-state-between-components/(1)-LiftingStateUpByExample1';
...
export default function App() {
  return (
    <section>
      ...
      <SharingStateBetweenComponents1 />
    </section>
  );
}
